...
namespace ComfortSmtpScoped\Doctrine\Inflector\Rules\English;
...
class Inflectible
{
    ...
    {
        (yield new Transformation(new Pattern('(s)tatuses$'), 'ComfortSmtpScoped\\1\\2tatus'));
        (yield new Transformation(new Pattern('(s)tatus$'), 'ComfortSmtpScoped\\1\\2tatus'));
        (yield new Transformation(new Pattern('(c)ampus$'), 'ComfortSmtpScoped\\1\\2ampus'));
        (yield new Transformation(new Pattern('^(.*)(menu)s$'), 'ComfortSmtpScoped\\1\\2'));
        ...
        (yield new Transformation(new Pattern('(m)ovies$'), 'ComfortSmtpScoped\\1\\2ovie'));
        (yield new Transformation(new Pattern('(s)eries$'), 'ComfortSmtpScoped\\1\\2eries'));
        ...
        (yield new Transformation(new Pattern('(analy|diagno|^ba|(p)arenthe|(p)rogno|(s)ynop|(t)he)ses$'), 'ComfortSmtpScoped\\1\\2sis'));
        ...
        (yield new Transformation(new Pattern('(p)eople$'), 'ComfortSmtpScoped\\1\\2erson'));
        (yield new Transformation(new Pattern('(m)en$'), '\\1an'));
        (yield new Transformation(new Pattern('(c)hildren$'), 'ComfortSmtpScoped\\1\\2hild'));
        (yield new Transformation(new Pattern('(f)eet$'), '\\1oot'));
        (yield new Transformation(new Pattern('(n)ews$'), 'ComfortSmtpScoped\\1\\2ews'));
    ...
    {
        (yield new Transformation(new Pattern('(s)tatus$'), 'ComfortSmtpScoped\\1\\2tatuses'));
        (yield new Transformation(new Pattern('(quiz)$'), '\\1zes'));
        (yield new Transformation(new Pattern('^(ox)$'), 'ComfortSmtpScoped\\1\\2en'));
        ...
        (yield new Transformation(new Pattern('(?:([^f])fe|([lr])f)$'), 'ComfortSmtpScoped\\1\\2ves'));
        ...
        (yield new Transformation(new Pattern('(buffal|her|potat|tomat|volcan)o$'), 'ComfortSmtpScoped\\1\\2oes'));
