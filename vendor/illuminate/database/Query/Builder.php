...
use ComfortSmtpScoped\Illuminate\Database\Concerns\BuildsQueries;
use ComfortSmtpScoped\Illuminate\Database\Concerns\ExplainsQueries;
use ComfortSmtpScoped\Illuminate\Database\ConnectionInterface;
use ComfortSmtpScoped\Illuminate\Database\Eloquent\Builder as EloquentBuilder;
use ComfortSmtpScoped\Illuminate\Database\Eloquent\Relations\Relation;
use ComfortSmtpScoped\Illuminate\Database\Query\Grammars\Grammar;
use ComfortSmtpScoped\Illuminate\Database\Query\Processors\Processor;
use ComfortSmtpScoped\Illuminate\Pagination\Paginator;
use ComfortSmtpScoped\Illuminate\Support\Arr;
use ComfortSmtpScoped\Illuminate\Support\Collection;
use ComfortSmtpScoped\Illuminate\Support\LazyCollection;
use ComfortSmtpScoped\Illuminate\Support\Str;
use ComfortSmtpScoped\Illuminate\Support\Traits\ForwardsCalls;
use ComfortSmtpScoped\Illuminate\Support\Traits\Macroable;
...
class Builder
{
    ...
    {
        return \tap($this->clone(), function ($clone) use($properties) {
    ...
    {
        return \tap($this->clone(), function ($clone) use($except) {
