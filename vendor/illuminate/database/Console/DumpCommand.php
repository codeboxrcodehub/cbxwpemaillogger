...
use ComfortSmtpScoped\Illuminate\Database\ConnectionResolverInterface;
use ComfortSmtpScoped\Illuminate\Database\Events\SchemaDumped;
use ComfortSmtpScoped\Illuminate\Filesystem\Filesystem;
use ComfortSmtpScoped\Illuminate\Support\Facades\Config;
class DumpCommand extends Command
{
    ...
    {
        return \tap($this->option('path') ?: database_path('schema/' . $connection->getName() . '-schema.dump'), function ($path) {
