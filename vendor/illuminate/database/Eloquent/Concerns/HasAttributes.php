...
use ComfortSmtpScoped\Illuminate\Contracts\Database\Eloquent\CastsInboundAttributes;
use ComfortSmtpScoped\Illuminate\Contracts\Support\Arrayable;
use ComfortSmtpScoped\Illuminate\Database\Eloquent\Casts\AsArrayObject;
use ComfortSmtpScoped\Illuminate\Database\Eloquent\Casts\AsCollection;
use ComfortSmtpScoped\Illuminate\Database\Eloquent\Casts\Attribute;
use ComfortSmtpScoped\Illuminate\Database\Eloquent\InvalidCastException;
use ComfortSmtpScoped\Illuminate\Database\Eloquent\JsonEncodingException;
use ComfortSmtpScoped\Illuminate\Database\Eloquent\Relations\Relation;
use ComfortSmtpScoped\Illuminate\Database\LazyLoadingViolationException;
use ComfortSmtpScoped\Illuminate\Support\Arr;
use ComfortSmtpScoped\Illuminate\Support\Carbon;
use ComfortSmtpScoped\Illuminate\Support\Collection as BaseCollection;
use ComfortSmtpScoped\Illuminate\Support\Facades\Crypt;
...
trait HasAttributes
{
    ...
    protected function getRelationshipFromMethod($method)
    {
        ...
        return \tap($relation->getResults(), function ($results) use($method) {
    ...
    {
        return \tap($this->getArrayAttributeByKey($key), function (&$array) use($path, $value) {
