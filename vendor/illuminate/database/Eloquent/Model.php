...
use ArrayAccess;
use ComfortSmtpScoped\Illuminate\Contracts\Broadcasting\HasBroadcastChannel;
use ComfortSmtpScoped\Illuminate\Contracts\Queue\QueueableCollection;
use ComfortSmtpScoped\Illuminate\Contracts\Queue\QueueableEntity;
use ComfortSmtpScoped\Illuminate\Contracts\Routing\UrlRoutable;
use ComfortSmtpScoped\Illuminate\Contracts\Support\Arrayable;
use ComfortSmtpScoped\Illuminate\Contracts\Support\CanBeEscapedWhenCastToString;
use ComfortSmtpScoped\Illuminate\Contracts\Support\Jsonable;
use ComfortSmtpScoped\Illuminate\Database\ConnectionResolverInterface as Resolver;
use ComfortSmtpScoped\Illuminate\Database\Eloquent\Collection as EloquentCollection;
...
use ComfortSmtpScoped\Illuminate\Database\Eloquent\Relations\HasManyThrough;
use ComfortSmtpScoped\Illuminate\Database\Eloquent\Relations\Pivot;
...
use ComfortSmtpScoped\Illuminate\Support\Traits\ForwardsCalls;
...
abstract class Model implements Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
    ...
    protected function incrementOrDecrement($column, $amount, $extra, $method)
    {
        ...
        return \tap($this->setKeysForSaveQuery($query)->{$method}($column, $amount, $extra), function () use($column) {
            $this->syncChanges();
    ...
    public function replicate(array $except = null)
    {
        ...
        return \tap(new static(), function ($instance) use($attributes) {
