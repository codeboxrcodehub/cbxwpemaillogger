...
use Closure;
use ComfortSmtpScoped\Faker\Generator;
use ComfortSmtpScoped\Illuminate\Container\Container;
use ComfortSmtpScoped\Illuminate\Contracts\Foundation\Application;
...
abstract class Factory
{
    ...
    public function make($attributes = [], ?Model $parent = null)
    {
        ...
        if ($this->count === null) {
            return \tap($this->makeInstance($parent), function ($instance) {
    ...
    protected function makeInstance(?Model $parent)
    {
        return Model::unguarded(function () use($parent) {
            return \tap($this->newModel($this->getExpandedAttributes($parent)), function ($instance) {
                if (isset($this->connection)) {
