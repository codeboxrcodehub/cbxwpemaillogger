...
use ComfortSmtpScoped\Doctrine\DBAL\Schema\SchemaException;
...
use ComfortSmtpScoped\Illuminate\Database\Events\MigrationEnded;
use ComfortSmtpScoped\Illuminate\Database\Events\MigrationsEnded;
use ComfortSmtpScoped\Illuminate\Database\Events\MigrationsStarted;
use ComfortSmtpScoped\Illuminate\Database\Events\MigrationStarted;
use ComfortSmtpScoped\Illuminate\Database\Events\NoPendingMigrations;
...
use ReflectionClass;
use ComfortSmtpScoped\Symfony\Component\Console\Output\OutputInterface;
class Migrator
{
    /**
    ...
    public function usingConnection($name, callable $callback)
    {
        ...
        return \tap($callback(), function () use($previousConnection) {
