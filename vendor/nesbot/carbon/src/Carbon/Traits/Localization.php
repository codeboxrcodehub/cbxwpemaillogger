 ...
 */
namespace ComfortSmtpScoped\Carbon\Traits;

use ComfortSmtpScoped\Carbon\CarbonInterface;
use ComfortSmtpScoped\Carbon\Exceptions\InvalidTypeException;
use ComfortSmtpScoped\Carbon\Exceptions\NotLocaleAwareException;
use ComfortSmtpScoped\Carbon\Language;
use ComfortSmtpScoped\Carbon\Translator;
use ComfortSmtpScoped\Carbon\TranslatorStrongTypeInterface;
use Closure;
use ComfortSmtpScoped\Symfony\Component\Translation\TranslatorBagInterface;
use ComfortSmtpScoped\Symfony\Component\Translation\TranslatorInterface;
use ComfortSmtpScoped\Symfony\Contracts\Translation\LocaleAwareInterface;
use ComfortSmtpScoped\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;
// @codeCoverageIgnoreStart
if (interface_exists('ComfortSmtpScoped\Symfony\Contracts\Translation\TranslatorInterface') && !interface_exists('ComfortSmtpScoped\Symfony\Component\Translation\TranslatorInterface')) {
    class_alias('ComfortSmtpScoped\Symfony\Contracts\Translation\TranslatorInterface', 'ComfortSmtpScoped\Symfony\Component\Translation\TranslatorInterface');
}
