...
use Closure;
use ComfortSmtpScoped\Rakit\Validation\Rules\Interfaces\BeforeValidate;
use ComfortSmtpScoped\Rakit\Validation\Rules\Interfaces\ModifyValue;
use ComfortSmtpScoped\Rakit\Validation\Rules\Required;
class Validation
{
    ...
    protected function resolveRules($rules) : array
    {
        ...
        foreach ($rules as $i => $rule) {
            ...
            if (\is_string($rule)) {
                ...
                $validator = \call_user_func_array($validatorFactory, ['ComfortSmtpScoped\\callback', $rule]);
            } else {
