...
if ( ! class_exists( 'ComfortSmtpGeneralUserEmail', false ) ) :

	/**
	 * Class ComfortSmtpGeneralUserEmail file
	 *
	 * Sending email alert to user
	 */
	class ComfortSmtpGeneralUserEmail extends ComfortSmtpEmail {
		/**
		 * Constructor.
		 */
		...
		public function __construct() {
			...
			$this->description = esc_html__( 'Sends notification to user on general purpose.', 'cbxwpemaillogger' );

			$this->template_html = 'emails/generic_email_user.php';
		...
		public function trigger( $data, $attachments ) {
			...
			if(empty($data['to_email']) || empty($data['email_body'])){
				return;
			}

            if(!is_email($data['to_email'])) return;

			$this->placeholders['{email_body}']  = $data['email_body'];

			$content = $this->get_content();

			$this->recipient = $data['to_email'];
		...
		public function get_default_subject() {
			return esc_html__( 'Notification for User', 'cbxwpemaillogger' );
		...
		public function get_default_heading() {
			return esc_html__( 'Notification User', 'cbxwpemaillogger' );
	...
	}//end class ComfortSmtpGeneralUserEmail
endif;

return new ComfortSmtpGeneralUserEmail();